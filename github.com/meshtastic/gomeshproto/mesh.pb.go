...
func (MeshPacket_TransportMechanism) EnumDescriptor() ([]byte, []int) {
	return file_meshtastic_mesh_proto_rawDescGZIP(), []int{8, 2}
}
...
var file_meshtastic_mesh_proto_enumTypes = make([]protoimpl.EnumInfo, 12)
